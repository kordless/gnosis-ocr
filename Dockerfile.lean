# Lean Cloud Dockerfile for Gnosis OCR - NO MODELS INCLUDED
# Models will be mounted from GCS at runtime
...
# Create directories for storage and cache mount point
...
# Environment variables for cloud deployment with GCS FUSE mount
...
# Run the V2 application (uses GCS-mounted models)
